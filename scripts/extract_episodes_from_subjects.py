...
parser.add_argument('variable_map_file', type=unicode, help='CSV containing ITEMID-to-VARIABLE map.')
parser.add_argument('reference_range_file', type=unicode, help='CSV containing reference ranges for VARIABLEs.')
