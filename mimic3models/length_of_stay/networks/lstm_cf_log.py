...
class Network(nn_utils.BaseNetwork):
    ...
    def process_input(self, data_raw):
        ...
        bin_ids = [metrics.get_bin_log(x, self.nbins) for x in ys]
    ...
    def say_name(self):
        self.network_class_name = "lstm_cf_log"
    ...
    def step(self, mode):
        ...
        return {"prediction": [metrics.get_estimate_log(x, self.nbins) for x in ret[0]],
                "answers": ys,
                "current_loss": ret[1],
                "loss_reg": ret[2],
